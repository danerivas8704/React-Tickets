...
namespace Tickets.Seguridad.Utilidades
{
    public class Utilidades
    {
        ...
        public string generarJWT(LoginDTO modelo)
        {
            //crear la informacion del usuario para token
            var userClaims = new[]
            {
                new Claim(ClaimTypes.NameIdentifier, modelo.Usuario.ToString()),
                new Claim(ClaimTypes.Email, modelo.Clave!)
            };
